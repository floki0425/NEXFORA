...
test("portal navigation lists active Phase 7/9/10 functionality while files and revisions stay project-scoped", () => {
  ...
  for (const path of ["files", "revisions", "settings"]) {
