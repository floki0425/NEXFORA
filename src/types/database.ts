  ...
  public: {
    Tables: {
      ...
      subscription_usage: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "subscription_usage_recorded_by_fkey"
            columns: ["recorded_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "subscription_usage_subscription_org_fkey"
      ...
      subscriptions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "subscriptions_client_organization_fkey"
            columns: ["client_id", "organization_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id", "organization_id"]
          ...
          {
            foreignKeyName: "subscriptions_project_org_client_fkey"
            columns: ["project_id", "organization_id", "client_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id", "organization_id", "client_id"]
      ...
      support_tickets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "support_tickets_client_organization_fkey"
            columns: ["client_id", "organization_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id", "organization_id"]
          ...
          {
            foreignKeyName: "support_tickets_project_org_client_fkey"
            columns: ["project_id", "organization_id", "client_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id", "organization_id", "client_id"]
      ...
      ticket_activities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ticket_activities_ticket_organization_fkey"
    ...
    Functions: {
      ...
      get_proposal_win_rate_report: {
        Args: { p_created_by?: string; p_from?: string; p_to?: string }
        Returns: Json
      }
      get_revenue_report: {
      ...
      list_notification_dispatch_failures: {
        Args: { p_limit?: number }
        Returns: {
          action: string
          audit_log_id: string
      ...
      raise_due_invoice_reminders: { Args: never; Returns: number }
      raise_due_lead_follow_ups: { Args: never; Returns: number }
      raise_due_renewal_reminders: { Args: never; Returns: number }
      ...
      reopen_ticket_by_client: {
        Args: { p_comment: string; target_ticket_id: string }
        Returns: {
          status: string
        }[]
      }
      ...
      set_notification_preference: {
        Args: { p_email: boolean; p_event_type: string; p_in_app: boolean }
        Returns: undefined
      }
